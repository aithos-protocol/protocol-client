...
- REMOVED the orphan `converseEndpoint()` (P6.4 of
  PLAN-MCP-UNIFICATION-2026-06): the platform `/mcp/converse` scaffold stays
  dormant — spec §12 is now the behavioral reference of the local MCP server,
  not a server endpoint. No other change.
